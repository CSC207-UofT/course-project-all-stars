...
public abstract class Database {
    /**
     * Abstract class for Database to define the basic layout of methods
     */
    ...
    public static void writeData(String name, String address, String sex, int age, int health, boolean insurance,
    ...
    public static boolean rowExist(int row) {
        /**
